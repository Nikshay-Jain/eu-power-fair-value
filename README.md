...
│   
├── qa_report/
│   ├── all reports generated by parts 1
│   └── qa_report_qa_summary.txt
│       ...
|
├── results/
│   └── all results generated by parts 2-4
│       ...
│
├── src/
│   ├── main.py     # Smooth pipeline orchestration
...
- `results/part2_test_results.csv`    ----> test set metrics 
- .....
...
**Outputs**
- `results/part4_trader_commentary_evidence.txt`
...
### 4. Enable AI Commentary

```
export GOOGLE_API_KEY="<your_api_key_here>"
```

Note: If no API key is provided, the pipeline still runs with deterministic commentary.
...
| `results/part2_test_results.csv` | Final metrics over test data |
